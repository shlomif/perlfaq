...
Topaz. However, while Topaz provided valuable insights to the next version
of Perl and its implementation, it was ultimately abandoned.
...
on the various types of Internet forums runs a strong risk of starting an
unproductive Holy War.
...
scripts run by a program at its start up, such as F<.cshrc> or F<.ircrc>,
...
=item * Larry Wall's Talk "Programming is Hard, Let's Go Scripting" 

http://www.perl.com/pub/a/2007/12/06/soto-11.html

=item * Andy Lester's Stop saying "script"
